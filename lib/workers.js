...
workers.performCheck = function(originalCheckData){
    ...
    let path = parsedUrl.path; // Using 'path' and not 'pathname' because we want the full querystring
...
// Process the check outcome, update the check data as needed, trigger an alert as needed
